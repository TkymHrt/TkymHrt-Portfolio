...
const desktopWords = ["IT", "IS", "FRONT-END", "DEVELOPER'S", "PORTFOLIO", "SITE."];
const mobileWordsLine1 = ["IT", "IS", "FRONT-END", "DEVELOPER'S"];
const mobileWordsLine2 = ["PORTFOLIO", "SITE."];
